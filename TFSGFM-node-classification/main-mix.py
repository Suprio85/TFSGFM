...
def main():
    ...
    model = DualGCN(test_data.x1.shape[1], test_data.x2.shape[1], args.hidden_dimension, args.out_dimension, args.GCN_num1, args.GCN_num2)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--GCN_num1', type=int, default=3, help='GCN_layer_number')
    parser.add_argument('--GCN_num2', type=int, default=2, help='GCN_layer_number')
    parser.add_argument('--DAD', type=int, default= -1, help='DAD_layer_number. (Unknown dataset defaults to -1)')
    ...
    parser.add_argument('--train_datasets', type=str, nargs='+',default=['CiteSeer', 'PubMed', 'Cornell' ,'Chameleon', 'Squirrel'], help='train datasets.')
    parser.add_argument('--test_dataset', type=str,default='Cora', help='test dataset.')
